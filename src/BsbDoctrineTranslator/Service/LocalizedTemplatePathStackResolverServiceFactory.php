...
namespace BsbDoctrineTranslator\Service;

use Zend\ServiceManager\FactoryInterface;
use Zend\ServiceManager\ServiceLocatorInterface;
use BsbDoctrineTranslator\View\Resolver AS ViewResolver;

class LocalizedTemplatePathStackResolverServiceFactory implements FactoryInterface
{
    /**
     * {@inheritDoc}
     *
